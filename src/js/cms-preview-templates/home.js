      ...
      <div className="bg-off-white pv4">
        <div className="ph3 mw7 center">
          ...
          <div className="flex-ns mhn2-ns mb3">
            {(entry.getIn(["data", "behandelingen"]) || []).map((behandeling, i) => <div className="ph2-ns w-50-ns" key={i}>
              <img src={getAsset(behandeling.get("image"))} alt="" className="center db mb3" style={{ width: "240px" }} />
              <p>{behandeling.get("text")}</p>
            </div>)}
          </div>

          <div className="tc">
            <a href="#" className="btn raise">Alle behandelingen</a>
          </div>
        </div>
      </div>
        ...
        <div className="ph3 mw7 center">
          ...
          <div className="flex-l mhn2-l">
            <div className="w-40-l ph2-l">
              <h2 className="f2 b lh-title mb2">{entry.getIn(["data", "team", "heading"])}</h2>

              <p>{entry.getIn(["data", "team", "text"])}</p>
            </div>
